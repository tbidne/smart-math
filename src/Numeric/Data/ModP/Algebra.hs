...
--
-- @since 0.1
module Numeric.Data.ModP.Algebra
  ( -- * Type
    ModP (MkModP),
...
import Numeric.Data.ModP.Algebra.Internal (ModP (MkModP, UnsafeModP))
import Numeric.Data.ModP.Algebra.Internal qualified as Internal
