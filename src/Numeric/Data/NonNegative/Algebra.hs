...
-- In contrast to "Numeric.Data.NonNegative.Base", typeclass instances are
-- provided in terms of algebra-simple classes, where possible.
--
--
-- @since 0.1
module Numeric.Data.NonNegative.Algebra
  ( -- * Type
...
import Numeric.Data.NonNegative.Algebra.Internal
  ( NonNegative
      ( MkNonNegative,
        UnsafeNonNegative
      ),
  )
import Numeric.Data.NonNegative.Algebra.Internal qualified as Internal
