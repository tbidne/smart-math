...
--
-- @since 0.1
module Numeric.Data.Positive.Base
  ( -- * Type
    Positive (MkPositive),
...
import Numeric.Data.NonZero.Base (NonZero, reallyUnsafeNonZero, rmatching)
import Numeric.Data.Positive.Base.Internal (Positive (MkPositive, UnsafePositive))
import Numeric.Data.Positive.Base.Internal qualified as Internal
import Optics.Core
  ( ReversedPrism',
    ReversibleOptic (re),
    prism,
...
-- >>> import Numeric.Data.Positive.Base.Internal (unsafePositive)
