...
import Numeric.Data.ModN.Base.Internal (ModN (MkModN, UnsafeModN))
import Numeric.Data.ModN.Base.Internal qualified as Internal
import Optics.Core (ReversedPrism', prism, re)

-- $setup
-- >>> :set -XTemplateHaskell
-- >>> import Data.Int (Int8)
-- >>> import Numeric.Data.ModN.Base.Internal (mkModN)
